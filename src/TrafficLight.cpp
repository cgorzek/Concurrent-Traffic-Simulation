...
void TrafficLight::cycleThroughPhases()
{
    ...
    // rand reference: https://www.codegrepper.com/code-examples/cpp/c%2B%2B+random+between+two+numbers
    int randNum;
    int max = 6;
    int min = 4;
    ...
    while (true) {
        ...
        //std::cout << "DEBUG: randNum: " << randNum << " CurrPhase: "<< _currentPhase << std::endl;
